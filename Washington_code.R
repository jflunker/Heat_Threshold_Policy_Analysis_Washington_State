...
getwd()
setwd("/users/johnflunker/Desktop/UW/Heat threshold vulnerability/JIHOON CODE for GITHUB/DATA/data/3_within") # insert your file working directory where you saved prism data sets
...
poly = readOGR("/users/johnflunker/Desktop/UW/Heat threshold vulnerability/JIHOON CODE for GITHUB/DATA/data/county_shapefile/Washington_state.shp") # insert your file working directory where you saved prism data sets
...
poly = readOGR("/users/johnflunker/Desktop/UW/Heat threshold vulnerability/JIHOON CODE for GITHUB/DATA/data/county_shapefile/Washington_state.shp") # add path to your directory
...
getwd()
poly = shapefile("/users/johnflunker/Desktop/UW/Heat threshold vulnerability/JIHOON CODE for GITHUB/DATA/data/county_shapefile/Washington_state.shp") # add path to your directory
